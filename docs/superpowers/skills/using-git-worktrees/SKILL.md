...
- **Fix:** Auto-detect from project files (package.json, composer.json, etc.)
...
[Run php artisan test - 47 passing]
...
**Called by:**
- **superpowers:brainstorming** — REQUIRED when design is approved and implementation follows
